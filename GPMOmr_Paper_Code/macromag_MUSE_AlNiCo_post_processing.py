...
from simsopt.solve.macromagnetics import MacroMag, SolverParams, Tiles
from simsopt.geo import SurfaceRZFourier
from simsopt.objectives import SquaredFlux
from simsopt.util import calculate_modB_on_major_radius, initialize_coils_for_pm_optimization
...
mac, A_mm = mac.direct_solve(
    N_new_rows=N_full,
    params=SolverParams(use_coils=False, krylov_tol=1e-6, krylov_it=20, print_progress=False),
)
M_mm = tiles.M.copy()
...
mac, A_full = mac.direct_solve(
    N_new_rows=N_full,
    params=SolverParams(use_coils=True, krylov_tol=1e-6, krylov_it=20, print_progress=False),
)
M_mc = tiles.M.copy()
